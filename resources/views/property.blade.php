    ...
    if (list.length === 0) {
        grid.innerHTML = `
            <div class="empty-state col-12">
                <img src="https://cdn-icons-png.flaticon.com/512/4076/4076501.png" alt="No Properties">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="property-card">
                ...
                <div class="property-body">
                    ...
                    <div class="property-location"><i class="bi bi-geo-alt-fill"></i> ${p.city}</div>
                    <div class="property-meta">
                        <i class="bi bi-door-open"></i> ${p.bedrooms} Beds |
                        <i class="bi bi-droplet-half"></i> ${p.bathrooms} Baths
                    </div>
                    <div class="property-footer">
                        <span class="price">₹${p.monthly_rent.toLocaleString()}/mo</span>
                        <a href="/properties/${p.property_id}" class="btn view-btn">View</a>
                    </div>
                </div>
            </div>
        </div>`;
...
// Initial render
document.addEventListener("DOMContentLoaded", () => renderProperties(properties));
</script>
