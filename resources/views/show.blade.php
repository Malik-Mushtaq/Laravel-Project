...
<div class="container py-5">
    <div id="property-container">
        <p class="text-center text-muted mt-5">Loading property details...</p>
    </div>
</div>

<script>
// propert array of object conatning data
const properties = [
    {
        "property_id": 10001,
...
// showing details dynamically
if (property) {
    container.innerHTML = `
        <div class="property-hero mb-5" style="background-image: url('${property.image_url}');">
            <div class="property-overlay"></div>
        </div>
        <div class="property-info-card">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="fw-bold">${property.title}</h2>
                <span class="property-price">₹${property.monthly_rent.toLocaleString()}/month</span>
            </div>
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                <a href="/properties" class="btn btn-outline-secondary action-btn">
                    <i class="bi bi-arrow-left"></i> Back to Listings
                </a>
                <a href="/checkout/${property.property_id}" class="btn btn-success action-btn">
