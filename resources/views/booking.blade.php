...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card border-0 shadow-lg overflow-hidden" id="checkout-container">
...
<!--sweetalert connection through cdn-->
...
// getting property id from path 
const pathParts = window.location.pathname.split('/');
const propertyId = parseInt(pathParts[pathParts.length - 1]);
const property = properties.find(p => p.property_id === propertyId);

const container = document.getElementById('checkout-container');

// if property is found then show 
if (property) {
    container.innerHTML = `
        <div class="row g-0">
            ...
            <div class="col-md-6 bg-light position-relative">
                <img src="${property.image_url}" 
                     ...
                     alt="${property.title}">
                <div class="p-4 position-absolute bottom-0 w-100 bg-dark bg-opacity-75 text-white">
                    <h3 class="fw-bold">${property.title}</h3>
                    <p class="mb-1"><i class="bi bi-geo-alt-fill"></i> ${property.city}</p>
                    <p class="mb-1 small">${property.description}</p>
                    <hr class="border-light my-2">
                    <ul class="list-unstyled mb-0 small">
                        <li><strong>Type:</strong> ${property.property_type}</li>
                        <li><strong>Bedrooms:</strong> ${property.bedrooms}</li>
                        <li><strong>Bathrooms:</strong> ${property.bathrooms}</li>
                        <li><strong>Rent:</strong> ₹${property.monthly_rent.toLocaleString()}/month</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-6 bg-white">
                <div class="p-5">
                    <h3 class="fw-bold text-success mb-4">
                        <i class="bi bi-calendar-check"></i> Booking Checkout
                    </h3>

                    <form id="bookingForm">
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-secondary">Full Name</label>
                            <input type="text" id="name" class="form-control form-control-lg shadow-sm" placeholder="Enter your full name" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold text-secondary">Phone Number</label>
                            <input type="text" id="phone" class="form-control form-control-lg shadow-sm" placeholder="+1 234 567 890" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold text-secondary">Preferred Booking Date</label>
                            <input type="date" id="date" class="form-control form-control-lg shadow-sm" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold text-secondary">Rent</label>
                            <input type="text" class="form-control form-control-lg shadow-sm" value="₹${property.monthly_rent.toLocaleString()}" readonly>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold text-secondary">Payment Method</label>
                            <select id="payment_method" class="form-select form-select-lg shadow-sm" required>
                        ...
                        <div id="extended-payment-details" style="display: none;">
                            <div class="mb-3">
                                <label class="form-label fw-semibold text-secondary">Card / PayPal Number</label>
                                <input type="text" id="card_number" class="form-control form-control-lg shadow-sm" placeholder="1234 5678 9012 3456">
                            </div>
                            <div class="row">
                                <div class="col-6 mb-3">
                                    <label class="form-label fw-semibold text-secondary">Expiry Date</label>
                                    <input type="text" id="expiry" class="form-control form-control-lg shadow-sm" placeholder="MM/YY">
                                </div>
                                <div class="col-6 mb-3">
                                    <label class="form-label fw-semibold text-secondary">CVV</label>
                                    <input type="text" id="cvv" class="form-control form-control-lg shadow-sm" placeholder="123">
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="/properties" class="d-block text-center mt-4 text-decoration-none text-muted">
    ...
    // if user select paypal or any card method extends form
    const paymentSelect = document.getElementById('payment_method');
    const extendedDetails = document.getElementById('extended-payment-details');
    paymentSelect.addEventListener('change', () => {
        extendedDetails.style.display = (paymentSelect.value === 'card' || paymentSelect.value === 'paypal') ? 'block' : 'none';
    });

    // handle booking form with sweetalert
    document.getElementById('bookingForm').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            ...
            text: `${name}, your booking for "${property.title}" on ${date} has been confirmed.`,
    ...
    container.innerHTML = `
        <div class="text-center py-5">
            <h4 class="text-danger mb-3">Property not found 😕</h4>
            <a href="/properties" class="btn btn-outline-primary">Back to Listings</a>
        </div>
    `;
}
</script>
...
/* === Base (Desktop) === */
#checkout-container .col-md-6.bg-light {
  position: relative;
  height: 100vh; /* full height view */
  overflow: hidden;
}

#checkout-container .col-md-6.bg-light img {
  width: 100%;
  height: 100%;
  object-fit: cover;
...
#checkout-container .col-md-6.bg-light .p-4 {
  position: absolute;
  bottom: 0;
  width: 100%;
...
@media (min-width: 768px) and (max-width: 1024px) {
  #checkout-container .col-md-6.bg-light {
    height: 500px; /* reduce full height */
  }
  ...
  #checkout-container .col-md-6.bg-white .p-5 {
...
@media (max-width: 767px) {
  ...
  #checkout-container h3.fw-bold.text-success.mb-4 {
    font-size: 1.5rem;
    text-align: center;
  }

  #checkout-container button.btn-lg {
    font-size: 1rem;
    padding: 0.8rem;
  }
}
