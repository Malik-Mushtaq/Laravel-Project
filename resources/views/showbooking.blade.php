                ...
                <div class="col-md-6 col-lg-4 booking-card">
                    <div class="card shadow-sm border-0 h-100">
                        ...
                        <div class="card-body text-start">
                            <h5 class="card-title fw-bold text-dark">{{ $property->title ?? 'Unknown Property' }}</h5>
                            <p class="text-muted small mb-2"><i class="bi bi-geo-alt"></i> {{ $property->city ?? 'N/A' }}</p>
                            <ul class="list-unstyled small">
                                <li><strong>Rent:</strong> ₹{{ $property->monthly_rent ?? 'N/A' }}/month</li>
