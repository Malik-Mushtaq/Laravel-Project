...
class PropertySeeder extends Seeder
{
    ...
    [
	 ...
	 "reviews"=> [
            [
                "name"=> "John Doe",
                "rating"=> 5,
                "text"=> "Absolutely loved the space! Great lighting and peaceful neighborhood."
            ],
            [
                "name"=> "Jane Smith",
                "rating"=> 4,
                "text"=> "Beautiful home but the kitchen could use a few more utensils."
            ],
            [
                "name"=> "Sam Wilson",
                "rating"=> 5,
                "text"=> "The backyard is perfect for small gatherings. Highly recommend!"
            ]
        ]
        ],
    [
 ...
 "reviews"=> [
    ...
    [
        ...
        "status"=> "",
        "city"=> "Capital City",
        "description"=> "Contempora/ry 2-bedroom 2-bathroom apartment located downtown, featuring a bright open layout and balcony views of the skyline.",
  ...
  foreach ($properties as $p) {
            ...
            if (str_starts_with($p['image_url'], 'data:image')) {
                $imageData = explode(',', $p['image_url'])[1];
                $imageName = 'properties/' . $p['property_id'] . '.jpg';
                Storage::disk('public')->put($imageName, base64_decode($imageData));
                $imagePath = $imageName;
            } else {
                $imagePath = $p['image_url']; // URL
            }
